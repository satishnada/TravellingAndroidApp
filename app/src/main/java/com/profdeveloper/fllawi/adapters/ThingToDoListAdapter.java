...
public class ThingToDoListAdapter extends RecyclerView.Adapter<ThingToDoListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((SearchResultActivity)context).onThingToDoItemClick(datum);
            }
        });
        ...
        holder.rattingBarReview.setRating(datum.getAvrageUserRating());
