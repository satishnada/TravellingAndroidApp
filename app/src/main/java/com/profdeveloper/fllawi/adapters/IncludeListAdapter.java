...
public class IncludeListAdapter extends RecyclerView.Adapter<IncludeListAdapter.ViewHolder> {

    private Context context;
    private ArrayList<String> includeList = new ArrayList<>();

    public IncludeListAdapter(Context context, List<String> allowedList) {
        this.context = context;
        this.includeList = (ArrayList<String>) allowedList;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
     ...
     /*   ImageLoader.getInstance().loadImage(Utility.BASE_URL+"/"+amenitiesList.get(position).get, new SimpleImageLoadingListener() {
        ...
        holder.tvServiceName.setText(includeList.get(position));
    }
