...
public class Datum implements Serializable {
    ...
    @Expose
    private float avrage_user_rating;
    ...
    public float getAvrage_user_rating() {
        return avrage_user_rating;
    }

    public void setAvrage_user_rating(float avrage_user_rating) {
        this.avrage_user_rating = avrage_user_rating;
    }
}