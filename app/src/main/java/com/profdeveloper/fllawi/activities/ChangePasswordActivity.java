    ...
    private void userChangePassword() {
        try {
            if (!Utility.isNetworkAvailable(mActivity)) {
                ...
                Call<LoginRequestResponse> call = service.userChangePassword(Utility.getLocale(),PreferenceData.getUserData().getId()+"",edtOldPassword.getText().toString(),edtConfirmPassword.getText().toString());
