...
import com.profdeveloper.fllawi.activities.NotificationActivity;
import com.profdeveloper.fllawi.activities.ProfileActivity;
import com.profdeveloper.fllawi.activities.SignInActivity;
import com.profdeveloper.fllawi.activities.WebViewActivity;
...
public abstract class BaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void closeSideMenu() {
        if (PreferenceData.getUserData() != null) {
            if (PreferenceData.getUserData().getPreferredLanguageId().equalsIgnoreCase("ar")) {
                try {
