        ...
        try {
            if (!Utility.isNetworkAvailable(mActivity)) {
               ...
               Utility.showProgress(this);
                ...
                Call<CommonRequestResponse> call = service.userSignUp(edtEmail.getText().toString().trim(),edtFirstName.getText().toString().trim(),edtLastName.getText().toString().trim(), edtPassword.getText().toString(),edtMobileNumber.getText().toString().trim());
